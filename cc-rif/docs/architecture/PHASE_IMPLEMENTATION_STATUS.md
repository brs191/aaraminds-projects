...
| 2 — Tier-B/C + embeddings + migrations | Implemented | DI/AOP/CrossService extractors, embedding service, schema migrations, infra bicep | (source: phase-2/extractor/di/src/main/java/com/aaraminds/rif/extractor/di/SpringDiExtractor.java) (source: phase-2/embedding-service/app.py#L255-L315) (source: phase-2/schema/migration_pgvector.sql#L27-L35) |
